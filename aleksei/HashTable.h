...
namespace Aleksei {
	...
	public:
		...
		Company* Find(const std::string& t) noexcept;
		Vector<Pair<Company*, size_t>> LookUp() const noexcept;
		template <typename Predicate>
		Vector<Pair<Company*, size_t>> LookUp(Predicate pred) const noexcept;
	...
	template <typename Predicate>
	Vector<Pair<Company*, size_t>> HashTable::LookUp(Predicate pred) const noexcept {
